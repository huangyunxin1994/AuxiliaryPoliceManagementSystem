                ...
                <a-col :md="24" :lg="17" :xl="19" :xxl="20">
                    <a-row :gutter="24">
                        ...
                        <a-col :md="6" :sm="24">
                            ...
                            <a-range-picker style="width: calc(100% - 100px);margin-bottom: 24px" @change="onChange" />
                        </a-col>
                        <a-col :md="6" :sm="24">
                        ...
                        <a-col :md="6" :sm="24" style="margin-bottom: 24px" >
                          <span class="table-page-search-submitButtons" >
                            ...
                            <a-button type="primary" @click="extensionCon" :disabled="selectedRows.length == 0">续约合同</a-button>
                            <a-button type="primary" style="margin-left: 8px" @click="newContract">新建合同</a-button>
                          </span>
                        </a-col>
                    </a-row>
...
<script>
    ...
    import formStep from "@/components/newConstractStep/StepForm"
    const tree = [{
        'key': 'key-01',
        'title': '研发中心',
        'icon': 'mail',
    ...
    data() {
      return {
          ...
          extension:[
                ...
                {label:'合同期限(月)',name:'deadline',type:'input',refName:'deadline',placeholder:'请输入整数'},
                {label:'上传文件',name:'uploadFile',type:'upload',refName:'uploadFile'}
          ]
      }
    },
    methods:{
